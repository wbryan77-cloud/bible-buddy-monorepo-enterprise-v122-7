...
**Generated:** 2026-07-19T20:29:18.662Z
**Duration:** 512s
**Server reachable at http://localhost:3000:** true

**Counts:** pass=36 warn=2 fail=1 skip=0
...
- **SCRIPTURE / openAiFirstRegressionTest**: timed out after 180000ms
...
- **PERFORMANCE / admin_dashboard_latency**: command-center in 5952ms (offline-precomputed snapshot aggregation; not on the live chat hot path)
