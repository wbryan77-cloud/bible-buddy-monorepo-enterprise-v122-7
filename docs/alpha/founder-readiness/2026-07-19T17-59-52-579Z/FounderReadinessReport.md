...
**Generated:** 2026-07-19T18:03:00.629Z
**Duration:** 188s
**Server reachable at http://localhost:3000:** true

**Counts:** pass=35 warn=2 fail=1 skip=0
...
- **[FAIL]** ADMIN — admin_/admin/api/bible-authority/command-center:FAIL, admin_/admin/api/bible-authority/review-queue:PASS, admin_/admin/api/bible-authority/knowledge-coverage-dashboard:PASS, admin_/admin/api/bible-authority/founder-console:PASS, admin_/admin/api/bible-authority/provider-health:PASS
...
- **[PASS]** PERFORMANCE — governed_doctrine_latency:PASS, concurrent_health_requests:PASS
- **[WARN]** DEPLOYMENT — render_yaml_present:PASS, render_start_command_present:PASS, render_health_check_path_present:WARN, no_prisma_migrate_in_build:PASS, env_sample_present:PASS, readme_present:PASS

## Critical failures

- **ADMIN / admin_/admin/api/bible-authority/command-center**: write EPIPE
