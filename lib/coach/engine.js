...
const { PHASE_SCRIPTS } = require('./scripts');
...
function summarizeForAdmin(qa, journal, actions, eng){
...
module.exports = { nextCoachStep, suggestionsFromQA, summarizeForAdmin };
