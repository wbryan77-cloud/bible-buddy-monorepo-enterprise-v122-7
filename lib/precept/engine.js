...
function syncAll(mapping){ const out=[]; for(const ref of Object.keys(mapping?.misapplied||{})){ out.push({ref, suggestions: checkPrecept(ref)}); } return out; }
...
module.exports = { checkPrecept, syncAll };
